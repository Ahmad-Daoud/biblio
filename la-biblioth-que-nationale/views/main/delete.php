...
<head>
    ...
    <!-- stylesheet utilisée uniquement dans la page delete.php -->
    <link rel="stylesheet" href="/xampp/Labibliothèquenationale/la-biblioth-que-nationale/CSS/delete.css">
    <!-- stylesheet utilisée uniquement dans la page delete.php -->
...
<div class="delform">
    <form action="model.php" method="get" name="submitdelete" id="delform">
        Selectionnez l'id du livre que vous voulez supprimer <input type="text" name ="bookid" placeholder="ID">
...
<!-- script pour changer la fonction du bouton submit en HTML / JS -->
<script src="/xampp/Labibliothèquenationale/la-biblioth-que-nationale/js/del.js"></script>
<!-- script pour changer la fonction du bouton submit en HTML / JS -->
