...
<head>
    ...
    <!-- fichier css unique à la page "404" -->
    <link rel="stylesheet" href="/xampp/Labibliothèquenationale/la-biblioth-que-nationale/CSS/404.css">
...
<!-- Il n'y a pas grand chose à dire, c'est un texte 404 -->
<div class="texterr"> <center>Il semble que vous avez attéri sur la mauvaise page :/</center></div>
<a href="/xampp/Labibliothèquenationale/la-biblioth-que-nationale/index.php?page=home">
    <center>
        <button class='btnerr'>
            <center>Retourner à la page d'acceuil</center>
        </button>
    </center>
</a>
<!-- Il n'y a pas grand chose à dire, c'est un texte 404 -->
