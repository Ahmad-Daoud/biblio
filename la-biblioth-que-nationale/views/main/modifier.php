...
<head>
    ...
    <!-- stylesheet utilisée uniquement dans la page modifier.php -->
    <link rel="stylesheet" href="/xampp/Labibliothèquenationale/la-biblioth-que-nationale/CSS/modifier.css">
    <!-- stylesheet utilisée uniquement dans la page modifier.php -->
...
<form action="model.php" name="submitmodify" method="get" id="modform">
    Indiquez l'id du livre que vous veuillez modifier<input type="text" name= "modifyid">
    <input type="submit">
</form>
